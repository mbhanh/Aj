...
if success then
    ...
    local Window = WindUI:CreateWindow({
        Title = "👑Nova HUB PVP v.0.1 | paid⚔️",
        Icon = "cat",
        Author = "My Nova | Discord     • https://discord.gg/VhCb6BfYy",
        Folder = "NovaHubFolder",
...
if not isMobile then -- เธเนเธญเธ OpenIcon เธเธเธกเธทเธญเธ–เธทเธญ
    ...
    -- เธฃเธนเธเธ เธฒเธเน€เธ•เนเธกเธเธธเนเธก
    IconImage.Size = UDim2.new(1, 0, 1, 0)
    IconImage.Position = UDim2.new(0, 0, 0, 0)
    IconImage.BackgroundTransparency = 1
    IconImage.Image = "rbxassetid://137877095538630"
    IconImage.Parent = OpenIcon
    -- เนเธซเนเธฃเธนเธเธ เธฒเธเนเธเนเธเน€เธซเธกเธทเธญเธเธเธธเนเธก
    IconCorner.CornerRadius = UDim.new(0, 8)
    IconCorner.Parent = IconImage
    -- Tween เธเธธเนเธก เธเธขเธฒเธขเนเธฅเธฐเธเธทเธเธเธเธฒเธ”
    local currentTween  -- เน€เธเนเธ Tween เธเธฑเธเธเธธเธเธฑเธ
    local isAnimating = false
    local function animateButton(button)
        if isAnimating then
            return
        end -- เธเนเธญเธเธเธฑเธ Tween เธเนเธญเธ
        isAnimating = true
    ...
    -- เนเธ•เธฐเธเธธเนเธกเธกเธทเธญเธ–เธทเธญเธชเธฅเธฑเธ UI + เธญเธเธดเน€เธกเธเธฑเนเธ
...
local flyJumpConnection = nil -- เธชเธณเธซเธฃเธฑเธเธกเธทเธญเธ–เธทเธญ
-- Combat/Misc
...
local function getClosestTarget()
    local closest = nil
    local shortestDistance = FOVRadius -- เนเธเน FOV เน€เธเนเธเธเธญเธเน€เธเธ•
        ...
        if player ~= LocalPlayer and player.Character then
            ...
            if head and humanoid and humanoid.Health > 0 and hrp then
                ...
                if onScreen then
                    ...
                    -- เธญเธขเธนเนเนเธ FOV เนเธฅเธฐเนเธกเนเธ–เธนเธเธขเธเน€เธงเนเธ
...
local function createBillboardForPlayer(player)
    ...
    if BillboardCache[player] then
        BillboardCache[player]:Destroy() -- เธฅเธเธญเธฑเธเน€เธเนเธฒเธเนเธญเธเธชเธฃเนเธฒเธเนเธซเธกเนเน€เธเธทเนเธญเธเนเธญเธเธเธฑเธเธเนเธฒเธ
            ...
            sendRemote.OnClientEvent:Connect(
                function(...)
                    if AutoSkipEnabled then
                        task.spawn(TrySkipCrate) -- เนเธเน task.spawn เน€เธเธทเนเธญเน€เธฃเธตเธขเธเนเธเนเธ—เธฑเธเธ—เธตเนเธเธ async
                    end
                end
            )
        end
        ...
        oldFire = hookfunction(Remote.FireServer, function(self, ...)
            ...
            if (SilentAimEnabled or GoodGunEnabled) and args[2] == "shoot_gun" and CurrentTarget then
                ...
                if head and humanoid and hrp and humanoid.Health > 0 then
                    ...
                    if myHead then
                        -- เธ•เธฃเธงเธเธชเธญเธเธงเนเธฒเน€เธเนเธฒเธซเธกเธฒเธขเธญเธขเธนเนเธซเธฅเธฑเธเธเธณเนเธเธเธซเธฃเธทเธญเนเธกเน
                        local isTargetBehindWall = isBehindWall(myHead.Position, aimPos)
                        
                        -- เธฃเธฐเธเธเธเธฅเธฒเธ”: เธ–เนเธฒเธญเธขเธนเนเธซเธฅเธฑเธเธเธณเนเธเธเนเธฅเธฐเน€เธเธดเธ” GoodGun เนเธซเนเธขเธดเธเธ—เธฐเธฅเธธ, เธ–เนเธฒเธญเธขเธนเนเธ”เนเธฒเธเธซเธเนเธฒเธเนเธขเธดเธเธเธเธ•เธด
                        if GoodGunEnabled and isTargetBehindWall then
                            -- เนเธซเธกเธ”เธขเธดเธเธ—เธฐเธฅเธธเธเธณเนเธเธ
                            ...
                            -- เนเธซเธกเธ”เธขเธดเธเธเธเธ•เธด (เนเธกเนเธ—เธฐเธฅเธธเธเธณเนเธเธ)
                        ...
                        -- เน€เธญเธเน€เธเธเธ•เนเน€เธกเธทเนเธญเธขเธดเธเนเธ”เธ
                        spawn(function()
                            wait(0.1)
                            if humanoid and humanoid.Health < humanoid.MaxHealth then
                                -- เน€เธญเธเน€เธเธเธ•เนเธขเธดเธเนเธ”เธ
...
-- StateChanged handler: เธ•เธฃเธงเธเธซเธฒ state เธ—เธตเนเน€เธเนเธ "เน€เธ" เธซเธฃเธทเธญเธ–เธนเธเธฅเนเธก
...
ContextActionService:BindAction(
    ...
    function(actionName, inputState, inputObject)
        ...
        -- Mobile: เนเธเนเธเธธเนเธก Jump เธเธญเธ Roblox
        ...
        if isJumpPressed then
            if inputState == Enum.UserInputState.Begin then
                isFlyingUp = true
                Humanoid.Jump = true -- เธเธฃเธฐเนเธ”เธ”เธเธเธ•เธด (เธกเธทเธญเธ–เธทเธญ) เธซเธฃเธทเธญเน€เธฃเธดเนเธกเธเธดเธ
...
-- =========================
-- Fly Update (เธฅเธญเธขเธเธถเนเธเธ•เนเธญเน€เธเธทเนเธญเธ)
-- =========================
RunService.RenderStepped:Connect(
    function(deltaTime)
...
local GoodGunToggle =
    Tab:Toggle(
    {
        Title = "Silent Aim(เธขเธดเธเธ—เธฐเธฅเธธ)",
        Default = false,
        ...
        Callback = function(state)
            ...
            if state then
                ...
                if WindUI then
                    WindUI:Notify(
                        {
                            Title = "โ… ESP Items Enabled",
                            Description = "โ… Item ESP functionality activated",
                            Duration = 3
                        }
                    )
                end
                ...
                if WindUI then
                    WindUI:Notify(
                        {
                            Title = "โ ESP Items Disabled",
                            Description = "โ Item ESP functionality deactivated",
                            Duration = 3
                        }
                    )
                end
...
local FlyPowerSlider =
    Tab_Character:Slider(
    {
        ...
        Callback = function(value)
            floatPower = tonumber(value) or 40
        end
    }
)
myConfig:Register("FlyPower", FlyPowerSlider)

-- Leg Sink (เธเธฒเธเธฐเธเธกเธ”เธดเธ)
Tab_Character:Divider()
Tab_Character:Section({Title = "LEG / ANTI-AIM:"})
local LegSinkToggle =
    Tab_Character:Toggle(
    {
        Title = "Leg Sink",
        ...
        Default = false,
        Callback = function(state)
            LegSinkEnabled = state
            if Humanoid then
                originalHipHeight = originalHipHeight or Humanoid.HipHeight
                if state then
                    pcall(function() Humanoid.HipHeight = (originalHipHeight or 0) - LegSinkAmount end)
                else
                    pcall(function() Humanoid.HipHeight = originalHipHeight or 0 end)
                end
            end
        end
    }
)
myConfig:Register("LegSink", LegSinkToggle)
...
local LegSinkSlider =
    Tab_Character:Slider(
    {
        Title = "Sink Amount",
        Step = 0.1,
        Value = {Min = 0, Max = 3, Default = LegSinkAmount},
        Callback = function(value)
            LegSinkAmount = tonumber(value) or 0.5
            if LegSinkEnabled and Humanoid then
                pcall(function() Humanoid.HipHeight = (originalHipHeight or 0) - LegSinkAmount end)
            end
        end
        ...
        Callback = function(state)
            ...
            if AutoSprintEnabled then
                ...
                if success and SprintModule then
                    ...
                    if SprintBar then
                        ...
                        if WindUI then
                            WindUI:Notify(
                                {
                                    Title = "INF STAMINA",
                                    Description = "Auto Sprint เนเธฅเธฐ Infinite Stamina เธ—เธณเธเธฒเธเนเธฅเนเธง",
                                    Duration = 3
                                }
                            )
                        end
                    ...
                    warn("โ เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เนเธซเธฅเธ” SprintModule เนเธ”เน!")
                    AutoSprintEnabled = false
                    AutoSprintToggle:Set(false)
                end
            else
                ...
                if WindUI then
                    WindUI:Notify(
                        {
                            Title = "โ Auto Sprint Disabled",
                            Description = "Auto Sprint เนเธฅเธฐ Infinite Stamina เธ–เธนเธเธเธดเธ”เนเธฅเนเธง",
                            Duration = 3
                        }
                    )
                end
                ...
                function()
                    local success, err =
                        ...
                        function()
                            ...
                            local ReplicatedStorage = game:GetService("ReplicatedStorage")
                            local player = Players.LocalPlayer
                            -- เธซเธฒ CounterTable เธญเธขเนเธฒเธเธเธฅเธญเธ”เธ เธฑเธข
                            local function findCounter()
                                for _, obj in ipairs(getgc and getgc(true) or {}) do
                                    if typeof(obj) == "table" and rawget(obj, "event") and rawget(obj, "func") then
                                        return obj
                            ...
                            -- เธเธฑเธเธเนเธเธฑเธเธชเนเธ Remote เนเธเธ local
                            local Net = {}
                            function Net.get(...)
                                local args = {...}
                                CounterTable.func = (CounterTable.func or 0) + 1
...
-- เนเธ—เธเธ—เธตเนเธเธฒเธฃเน€เธเนเธฒเธ–เธถเธเนเธ”เธขเธ•เธฃเธเธ”เนเธงเธขเธ•เธฑเธงเนเธเธฃ
local saveFunc = myConfig["Save"]
local deleteFunc = myConfig["Delete"]
local loadFunc = myConfig["Load"]
-- เธชเธฃเนเธฒเธ Section
Tab_misc:Section({Title = "Config Management"})
-- เธเธธเนเธกเธเธฑเธเธ—เธถเธ Config
